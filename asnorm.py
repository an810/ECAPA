...
parser.add_argument('--embedding_file_path',  type=str,   default="/kaggle/input/rawnet3-model/private_embeddings_file.pickle",  help='Path of save file for new embedding data')
parser.add_argument('--embedding_full_file_path',  type=str,   default="/kaggle/input/rawnet3-model/private_embeddings_full_file.pickle",  help='Path of save file for new embedding data')
...
parser.add_argument('--save_path',  type=str,   default="/kaggle/working/ECAPA/exps/exp1",                                     help='Path to save the score.txt and models')
...
if __name__ == '__main__':
    ...
    train_embedding_file = '/kaggle/input/rawnet3-model/train_embeddings_file.pickle'
    ...
    EER = tuneThresholdfromScore(final_scale, labels, [1, 0.1])[1]
    print("EER %2.2f%%"%(EER))
